...
async def fix_finances(request: Request):
    ...
    async with async_session() as db:
        ...
        rules = [
            ...
            (["такси", "яндекс go", "begovaya"], "Такси"),
            (["парковка"], "Парковка"),
            # Финансы
            (["иис", "совкомбанк"], "ИИС"),
            (["подушка", "бкс"], "Подушка"),
            ...
            # Магазины/вещи
            (["aéza", "аэза", "cothuk_", "cothuk"], "Вещи"),
            # Детские развлечения
            (["sandyland", "sandiland"], "Развлечения"),
            # Персональные переводы — в Подарки
            (["рома", "георгий", "fursov", "fursor", "kuchmina"], "Подарки"),
